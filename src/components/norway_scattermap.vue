<template>
  ...
  <button @click="drawTimeScatter">Load timeScatter</button>
  <button @click="drawTimeHeatMap">Load TimeHeatMap</button>
  <div>Select data seriesType: {{ seriesType }}</div>
  <input type="radio" id="one" value="scatter" v-model="seriesType" />
  <label for="one">scatter</label>
  <input type="radio" id="two" value="heatMap" v-model="seriesType" />
  <label for="two">heatMap</label>
  <div>Picked: {{ picked }}</div>
  <input type="radio" id="one" value="fisheries" v-model="picked" />
  <label for="one">fisheries</label>
  <input type="radio" id="two" value="hygiene" v-model="picked" />
  <label for="two">hygiene</label>
  <input type="radio" id="three" value="personal_use" v-model="picked" />
  <label for="three">personal_use</label>
  <input type="radio" id="four" value="industrial" v-model="picked" />
  <label for="four">industrial</label>
  <input type="radio" id="five" value="others" v-model="picked" />
  <label for="five">others</label>
  <input type="radio" id="six" value="all" v-model="picked" />
  <label for="six">all</label>
